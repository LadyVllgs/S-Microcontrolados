// CALCULO DEL CUADRADO DE UN NUMERO A PARTIR DE SUS NUMEROS IMPARES QUE CONTIENE
// INTEGRANTES:
// lEIDY VILLEGAS
// DANIEL CABALLERO
...
static char lineBuf[32];     // admitir hasta 31 caracteres  (sobra para valores de N realistas)
...
void setup() {
  ...
  Serial.println("Ingrese un numero mayor a cero");
  resetBuffer();
}
